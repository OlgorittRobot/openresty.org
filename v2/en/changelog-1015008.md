...
* upgraded [lua-resty-core](https://github.com/openresty/lua-resty-core#readme) to 0.1.16.
    ...
    * change: we now require OpenResty's LuaJIT branch to work properly on ARM64 since we make use of the [thread.exdata](https://github.com/openresty/luajit2#threadexdata) Lua API.
